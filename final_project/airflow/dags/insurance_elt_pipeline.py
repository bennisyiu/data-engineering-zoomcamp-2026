...
Expects: project at /opt/airflow/repo; injected private PostgreSQL host (Railway or Compose).
"""
...
with DAG(
    ...
    # Compose injects warehouse; Railway injects its private domain.
    _pg_export = ""
    _pg_dwh = dict(os.environ)
    _pg_dwh.setdefault("POSTGRES_HOST", "warehouse")
    _pg_dwh.setdefault("POSTGRES_PORT", "5432")
